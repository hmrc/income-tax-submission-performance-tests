...
trait PropertyUKAndForeignSimSteps extends PerformanceTestRunner{
  ...
  def ukAndforeignPropertyIndividualEOYYear(id: String, description: String): JourneyPart = setup(id, description) withRequests(
    ...
    postNonUKResidentPropertyUKAndForeign(taxYearEOY),
    getDeductingTaxFromNonUKResidentPropertyUKAndForeign(taxYearEOY),
    postDeductingTaxFromNonUKResidentPropertyUKAndForeign(taxYearEOY),
    getUKPropertyRentalIncomeUKAndForeign(taxYearEOY),
    postUKPropertyRentalIncomeUKAndForeign(taxYearEOY),
    getBalancingChargeUKAndForeign(taxYearEOY),
    postBalancingChargeUKAndForeign(taxYearEOY),
    getUKPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    postUKPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    getCalculatedPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    postCalculatedPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    getReversePremiumsReceivedUKAndForeign(taxYearEOY),
    postReversePremiumsReceivedUKAndForeign(taxYearEOY),
    getOtherIncomeFromPropertyUKAndForeign(taxYearEOY),
    postOtherIncomeFromPropertyUKAndForeign(taxYearEOY),
    getForeignRentalPropertyIncomeUKAndForeign(taxYearEOY),
    postForeignRentalPropertyIncomeUKAndForeign(taxYearEOY),
    getForeignBalancingChargeUKAndForeign(taxYearEOY),
    postForeignBalancingChargeUKAndForeign(taxYearEOY),
    getForeignPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    postForeignPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    getForeignCalculatedPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    postForeignCalculatedPremiumsForTheGrantOfALeaseUKAndForeign(taxYearEOY),
    getForeignOtherIncomeUKAndForeign(taxYearEOY),
    postForeignOtherIncomeUKAndForeign(taxYearEOY),
    getPropertyIncomeAllowanceClaimUKAndForeign(taxYearEOY),
    postPropertyIncomeAllowanceClaimUKAndForeign(taxYearEOY),
    getCheckYourAnswersUKAndForeign(taxYearEOY),
    postCheckYourAnswersUKAndForeign(taxYearEOY),
    getHaveYouFinishedUKAndForeign(taxYearEOY),
    postHaveYouFinishedUKAndForeign(taxYearEOY),
