...
object AuthLoginRequests extends ServicesConfiguration {
  ...
  def postIndividualLoginPage(nino: String, mtditid: String, userTaxYear: String = taxYear): HttpRequestBuilder = http("Post Individual Login page")
    .post(authLoginUrl + "/auth-login-stub/gg-sign-in": String)
    .formParam("authorityId", "")
    .formParam("gatewayToken", "")
    .formParam("redirectionUrl", s"$serviceUrl/$userTaxYear/start")
    ...
    .formParam("enrolment[0].taxIdentifier[0].value", s"$mtditid")
    .formParam("enrolment[0].state", "Activated")
    .formParam("enrolment[1].name", "IR-SA")
    .formParam("enrolment[1].taxIdentifier[0].name", "UTR")
    .formParam("enrolment[1].taxIdentifier[0].value", "123456790")
  ...
  def postTailoringIndividualLoginPage(nino: String, mtditid: String, userTaxYear: String = taxYear): HttpRequestBuilder = http("Post Tailoring Individual Login page")
    .post(authLoginUrl + "/auth-login-stub/gg-sign-in": String)
    .formParam("authorityId", "")
    .formParam("gatewayToken", "")
    .formParam("redirectionUrl", s"$serviceUrl/test-only/$userTaxYear/additional-parameters?ClientNino=$nino&ClientMTDID=$mtditid")
    .formParam("credentialStrength", "strong")
    .formParam("confidenceLevel", "250")
    .formParam("affinityGroup", "Individual")
    .formParam("nino", nino)
  ...
  def postAgentLoginPage(nino: String, mtditid: String, userTaxYear: String = taxYear): HttpRequestBuilder = http("Post Agent Login page")
    .post(authLoginUrl + "/auth-login-stub/gg-sign-in": String)
    .formParam("authorityId", "")
    .formParam("gatewayToken", "")
    .formParam("redirectionUrl", s"$serviceUrl/test-only/$userTaxYear/additional-parameters?ClientNino=$nino&ClientMTDID=$mtditid")
    ...
    .formParam("enrolment[1].state", "Activated")
    .formParam("enrolment[2].name", "HMRC-NI")
    .formParam("enrolment[2].taxIdentifier[0].name", "NINO")
    .formParam("enrolment[2].taxIdentifier[0].value", s"$nino")
    .formParam("enrolment[2].state", "Activated")
    .formParam("enrolment[3].name", "")
    .formParam("enrolment[3].taxIdentifier[0].name", "")
    .formParam("enrolment[3].taxIdentifier[0].value", "")
