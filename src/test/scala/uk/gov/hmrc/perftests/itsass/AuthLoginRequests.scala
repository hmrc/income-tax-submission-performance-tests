...
object AuthLoginRequests extends ServicesConfiguration {
  ...
  def postIndividualLoginPage(nino: String, mtditid: String): HttpRequestBuilder = http("Post Individual Login page")
    .post(authLoginUrl + "/auth-login-stub/gg-sign-in": String)
    .formParam("authorityId", "")
    .formParam("gatewayToken", "")
    .formParam("redirectionUrl", s"$serviceUrl/$taxYear/start")
  ...
  def postAgentLoginPage(nino: String, mtditid: String): HttpRequestBuilder = http("Post Agent Login page")
    .post(authLoginUrl + "/auth-login-stub/gg-sign-in": String)
    .formParam("authorityId", "")
    .formParam("gatewayToken", "")
    .formParam("redirectionUrl", s"$serviceUrl/test-only/$taxYear/additional-parameters?ClientNino=$nino&ClientMTDID=$mtditid")
    .formParam("credentialStrength", "strong")
    .formParam("confidenceLevel", "200")
