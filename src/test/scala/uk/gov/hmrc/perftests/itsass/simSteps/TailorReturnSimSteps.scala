...
trait TailorReturnSimSteps extends PerformanceTestRunner {
  ...
  def tailorReturnIndividual(id: String, description: String): JourneyPart = setup(id, description) withRequests(
    ...
    getCharitableDonationsPage,
    postCharitableDonationsPage,
    getChangeCharitableDonationsPage,
    postChangeCharitableDonationsPage,
    getFosterCarerPage,
    postFosterCarerPage,
    getChangeFosterCarerPage,
    postChangeFosterCarerPage,
    getChildBenefitPage,
    postChildBenefitPage,
    getChangeChildBenefitPage,
    postChangeChildBenefitPage,
    getChildBenefitIncomePage,
    postChildBenefitIncomePage,
    getChangeChildBenefitIncomePage,
    postChangeChildBenefitIncomePage,
    getHighIncomeChildBenefitChargePage,
    postHighIncomeChildBenefitChargePage,
    getChangeHighIncomeChildBenefitChargePage,
    postChangeHighIncomeChildBenefitChargePage,
    getMarriageAllowancePage,
    postMarriageAllowancePage,
    getChangeMarriageAllowancePage,
    postChangeMarriageAllowancePage,
    getTaxAvoidanceSchemesPage,
    postTaxAvoidanceSchemesPage,
    getChangeTaxAvoidanceSchemesPage,
    postChangeTaxAvoidanceSchemesPage,
