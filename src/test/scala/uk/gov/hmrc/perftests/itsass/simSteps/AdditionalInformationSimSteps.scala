...
//    postPoliciesRemoveConfirmationPage(taxYear)
  ...
  def businessTaxReliefsIndividual(id: String, description: String): JourneyPart = setup(id, description) withRequests(
    ...
    getCheckAnswersPostCessationTradeReliefPage(taxYear),
    postCheckAnswersPostCessationTradeReliefPage(taxYear),
    getNonDeductibleLoanInterestReliefPage(taxYear),
    postNonDeductibleLoanInterestReliefPage(taxYear, 50.99),
    getCheckAnswersNonDeductibleLoanInterestReliefPage(taxYear),
    postCheckAnswersNonDeductibleLoanInterestReliefPage(taxYear),
