...
trait SelfEmploymentExpensesSimStepsFS extends PerformanceTestRunner{
  ...
  def selfEmploymentExpensesIndividualEOYYear(id: String, description: String): JourneyPart = setup(id, description) withRequests(
    ...
    getAdvertisingAndMarketing(taxYearEOY),
    postAdvertisingAndMarketing(taxYearEOY),
    getEntertainmentCosts(taxYearEOY),
    postEntertainmentCosts(taxYearEOY),
    getStaffConstructionIndustry(taxYearEOY),
    postStaffConstructionIndustry(taxYearEOY),
    getFinancialExpenses(taxYearEOY),
    postFinancialExpenses(taxYearEOY),
