...
object BenefitsRequests extends ServicesConfiguration {
  ...
  def getReceivedBenefitsPage: HttpRequestBuilder = http("Get Received Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/company-benefits?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postReceivedBenefitsPage: HttpRequestBuilder = http("Post Received Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/company-benefits?employmentId=$${employmentId}": String)
  ...
  def getCarVanFuelBenefitsPage: HttpRequestBuilder = http("Get Car Van Fuel Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/car-van-fuel?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postCarVanFuelBenefitsPage: HttpRequestBuilder = http("Post Car Van Fuel Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/car-van-fuel?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getCompanyCarBenefitsPage: HttpRequestBuilder = http("Get Company Car Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/company-car?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postCompanyCarBenefitsPage: HttpRequestBuilder = http("Post Company Car Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/company-car?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getCompanyCarAmountBenefitsPage: HttpRequestBuilder = http("Get Company Car Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/company-car-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postCompanyCarAmountBenefitsPage: HttpRequestBuilder = http("Post Company Car Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/company-car-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
  ...
  def postNonQualifyingRelocationBenefitsPage: HttpRequestBuilder = http("Post Non Qualifying Relocation Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/non-qualifying-relocation?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))
  ...
  def getNonQualifyingRelocationAmountBenefitsPage: HttpRequestBuilder = http("Get Non Qualifying Relocation Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/non-qualifying-relocation-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))
  ...
  def getIncidentalOvernightCostsBenefitsPage: HttpRequestBuilder = http("Get Incidental Overnight Costs Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/incidental-overnight-costs?employmentId=$${employmentId}": String)
    .check(status.is(200))
  ...
  def postIncidentalOvernightCostsBenefitsPage: HttpRequestBuilder = http("Post Incidental Overnight Costs Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/incidental-overnight-costs?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))
  ...
  def getIncidentalOvernightCostsAmountBenefitsPage: HttpRequestBuilder = http("Get Incidental Overnight Costs Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/incidental-overnight-costs-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))
  ...
  def postIncidentalOvernightCostsAmountBenefitsPage: HttpRequestBuilder = http("Post Incidental Overnight Costs Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/incidental-overnight-costs-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "500")
    .check(status.is(303))

  def getEntertainmentBenefitsPage: HttpRequestBuilder = http("Get Entertainment Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/entertainment-expenses?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postEntertainmentBenefitsPage: HttpRequestBuilder = http("Post Entertainment Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/entertainment-expenses?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getEntertainmentAmountBenefitsPage: HttpRequestBuilder = http("Get Entertainment Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/entertainment-expenses-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postEntertainmentAmountBenefitsPage: HttpRequestBuilder = http("Post Entertainment Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/entertainment-expenses-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "500")
    .check(status.is(303))

  def getUtilitiesBenefitsPage: HttpRequestBuilder = http("Get Utilities Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/utility-general-service?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postUtilitiesBenefitsPage: HttpRequestBuilder = http("Post Utilities Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/utility-general-service?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getTelephoneBenefitsPage: HttpRequestBuilder = http("Get Telephone Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/telephone?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postTelephoneBenefitsPage: HttpRequestBuilder = http("Post Telephone Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/telephone?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getTelephoneAmountBenefitsPage: HttpRequestBuilder = http("Get Telephone Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/telephone-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postTelephoneAmountBenefitsPage: HttpRequestBuilder = http("Post Telephone Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/telephone-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
  ...
  def getEmployerServicesBenefitsPage: HttpRequestBuilder = http("Get Employer Services Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/employer-provided-services?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postEmployerServicesBenefitsPage: HttpRequestBuilder = http("Post Employer Services Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/employer-provided-services?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getEmployerServicesAmountBenefitsPage: HttpRequestBuilder = http("Get Employer Services Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/employer-provided-services-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postEmployerServicesAmountBenefitsPage: HttpRequestBuilder = http("Post Employer Services Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/employer-provided-services-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
  ...
  def getProfessionalFeesBenefitsPage: HttpRequestBuilder = http("Get Professional Fees Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/professional-fees-or-subscriptions?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postProfessionalFeesBenefitsPage: HttpRequestBuilder = http("Post Professional Fees Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/professional-fees-or-subscriptions?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getProfessionalFeesAmountBenefitsPage: HttpRequestBuilder = http("Get Professional Fees Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/professional-fees-or-subscriptions-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postProfessionalFeesAmountBenefitsPage: HttpRequestBuilder = http("Post Professional Fees Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/professional-fees-or-subscriptions-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "800")
    .check(status.is(303))

  def getOtherServicesBenefitsPage: HttpRequestBuilder = http("Get Other Services Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/other-services?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postOtherServicesBenefitsPage: HttpRequestBuilder = http("Post Other Services Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/other-services?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getOtherServicesAmountBenefitsPage: HttpRequestBuilder = http("Get Other Services Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/other-services-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postOtherServicesAmountBenefitsPage: HttpRequestBuilder = http("Post Other Services Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/other-services-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "900")
    .check(status.is(303))

  def getMedicalDentalChildcareBenefitsPage: HttpRequestBuilder = http("Get Medical Dental Childcare Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/medical-dental-childcare-education-loans?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postMedicalDentalChildcareBenefitsPage: HttpRequestBuilder = http("Post Medical Dental Childcare Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/medical-dental-childcare-education-loans?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getMedicalDentalBenefitsPage: HttpRequestBuilder = http("Get Medical Dental Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/medical-dental?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postMedicalDentalBenefitsPage: HttpRequestBuilder = http("Post Medical Dental Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/medical-dental?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getMedicalDentalAmountBenefitsPage: HttpRequestBuilder = http("Get Medical Dental Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/medical-dental-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postMedicalDentalAmountBenefitsPage: HttpRequestBuilder = http("Post Medical Dental Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/medical-dental-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "900")
    .check(status.is(303))

  def getChildcareBenefitsPage: HttpRequestBuilder = http("Get Childcare Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/childcare?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postChildcareBenefitsPage: HttpRequestBuilder = http("Post Childcare Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/childcare?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getChildcareAmountBenefitsPage: HttpRequestBuilder = http("Get Childcare Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/childcare-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postChildcareAmountBenefitsPage: HttpRequestBuilder = http("Post Childcare Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/childcare-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "900")
    .check(status.is(303))

  def getEducationalServicesBenefitsPage: HttpRequestBuilder = http("Get Educational Services Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/educational-services?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postEducationalServicesBenefitsPage: HttpRequestBuilder = http("Post Educational Services Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/educational-services?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getEducationalServicesAmountBenefitsPage: HttpRequestBuilder = http("Get Educational Services Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/educational-services-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postEducationalServicesAmountBenefitsPage: HttpRequestBuilder = http("Post Educational Services Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/educational-services-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "900")
    .check(status.is(303))

  def getBeneficialLoansBenefitsPage: HttpRequestBuilder = http("Get Beneficial Loans Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/beneficial-loans?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postBeneficialLoansBenefitsPage: HttpRequestBuilder = http("Post Beneficial Loans Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/beneficial-loans?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getBeneficialLoansAmountBenefitsPage: HttpRequestBuilder = http("Get Beneficial Loans Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/beneficial-loans-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postBeneficialLoansAmountBenefitsPage: HttpRequestBuilder = http("Post Beneficial Loans Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/beneficial-loans-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "900")
    .check(status.is(303))

  def getIncomeTaxOrIncurredCostsBenefitsPage: HttpRequestBuilder = http("Get Income Tax of Incurred Costs Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/employer-income-tax-or-incurred-costs?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postIncomeTaxOrIncurredCostsBenefitsPage: HttpRequestBuilder = http("Post Income Tax of Incurred Costs Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/employer-income-tax-or-incurred-costs?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getIncomeTaxBenefitsPage: HttpRequestBuilder = http("Get Income Tax Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/employer-income-tax?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postIncomeTaxBenefitsPage: HttpRequestBuilder = http("Post Income Tax Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/employer-income-tax?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getIncomeTaxAmountBenefitsPage: HttpRequestBuilder = http("Get Income Tax Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/employer-income-tax-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postIncomeTaxAmountBenefitsPage: HttpRequestBuilder = http("Post Income Tax Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/employer-income-tax-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "700")
    .check(status.is(303))

  def getIncurredCostsBenefitsPage: HttpRequestBuilder = http("Get Incurred Costs Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/incurred-costs?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postIncurredCostsBenefitsPage: HttpRequestBuilder = http("Post Incurred Costs Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/incurred-costs?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getIncurredCostsAmountBenefitsPage: HttpRequestBuilder = http("Get Incurred Costs Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/incurred-costs-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postIncurredCostsAmountBenefitsPage: HttpRequestBuilder = http("Post Incurred Costs Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/incurred-costs-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "700")
    .check(status.is(303))
  ...
  def getReimbursedCostsVouchersNonCashBenefitsPage: HttpRequestBuilder = http("Get Reimbursed Costs, Vouchers and Non Cash Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/reimbursed-costs-vouchers-non-cash-benefits?employmentId=$${employmentId}": String)
    .check(status.is(200))
  ...
  def postVouchersOrCreditCardsAmountBenefitsPage: HttpRequestBuilder = http("Post Vouchers or Credit Cards Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/vouchers-or-credit-cards-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "100")
    .check(status.is(303))

  def getNonCashBenefitsPage: HttpRequestBuilder = http("Get Non-Cash Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/non-cash-benefits?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postNonCashBenefitsPage: HttpRequestBuilder = http("Post Non-Cash Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/non-cash-benefits?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getNonCashAmountBenefitsPage: HttpRequestBuilder = http("Get Non-Cash Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/non-cash-benefits-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postNonCashAmountBenefitsPage: HttpRequestBuilder = http("Post Non-Cash Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/non-cash-benefits-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "100")
    .check(status.is(303))

  def getOtherBenefitsPage: HttpRequestBuilder = http("Get Other Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/other-benefits?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postOtherBenefitsPage: HttpRequestBuilder = http("Post Other Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/other-benefits?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getOtherBenefitsAmountPage: HttpRequestBuilder = http("Get Other Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/other-benefits-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postOtherBenefitsAmountPage: HttpRequestBuilder = http("Post Other Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/other-benefits-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "100")
    .check(status.is(303))

  def getAssetsOrAssetsTransferBenefitsPage: HttpRequestBuilder = http("Get Assets or Assets Transfer Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/assets?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postAssetsOrAssetsTransferBenefitsPage: HttpRequestBuilder = http("Post Assets or Assets Transfer Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/assets?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getAssetsBenefitsPage: HttpRequestBuilder = http("Get Assets Available for Use Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/assets-available-for-use?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postAssetsBenefitsPage: HttpRequestBuilder = http("Post Assets Available for Use Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/assets-available-for-use?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getAssetsBenefitsAmountPage: HttpRequestBuilder = http("Get Assets Available for Use Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/assets-available-for-use-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postAssetsBenefitsAmountPage: HttpRequestBuilder = http("Post Assets Available for Use Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/assets-available-for-use-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "100")
    .check(status.is(303))

  def getAssetsTransferBenefitsPage: HttpRequestBuilder = http("Get Assets Transfer Benefits Question Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/assets-to-keep?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postAssetsTransferBenefitsPage: HttpRequestBuilder = http("Post Assets Transfer Benefits Question Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/assets-to-keep?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("value", true)
    .check(status.is(303))

  def getAssetsTransferBenefitsAmountPage: HttpRequestBuilder = http("Get Assets Transfer Benefits Amount Page")
    .get(s"${employmentsUrl(taxYearEOY)}/benefits/assets-to-keep-amount?employmentId=$${employmentId}": String)
    .check(status.is(200))

  def postAssetsTransferBenefitsAmountPage: HttpRequestBuilder = http("Post Assets Transfer Benefits Amount Page")
    .post(s"${employmentsUrl(taxYearEOY)}/benefits/assets-to-keep-amount?employmentId=$${employmentId}": String)
    .formParam("""csrfToken""", """${csrfToken}""")
    .formParam("amount", "100")
    .check(status.is(303))
